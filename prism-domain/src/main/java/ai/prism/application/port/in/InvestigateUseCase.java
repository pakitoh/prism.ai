 ...
 * concrete service.
 */
public interface InvestigateUseCase {

    /**
     * Runs an investigation to completion and returns the resulting aggregate,
     * either {@code CONCLUDED} with a finding or {@code FAILED} with a reason.
     */
