...
/**
 * In-memory {@link InvestigationKnowledgeBase}: a first implementation that
 ...
 */
public class InMemoryInvestigationKnowledgeBase implements InvestigationKnowledgeBase {
    ...
    public InMemoryInvestigationKnowledgeBase(Clock clock) {
        this.clock = Objects.requireNonNull(clock, "clock must not be null");
    }

    @Override
    public void remember(Investigation investigation) {
        investigation.finding().ifPresent(finding -> entries.add(new Entry(
