...
class InMemoryInvestigationKnowledgeBaseTest {

    private static final Instant NOW = Instant.parse("2026-06-11T10:00:00Z");

    private final InMemoryInvestigationKnowledgeBase knowledgeBase =
            new InMemoryInvestigationKnowledgeBase(Clock.fixed(NOW, ZoneOffset.UTC));
